...
My personal experience is that this is all but gone as of April 2026. My stack is Codex (always latest OpenAI model), shell scripts, a few custom sub agents (prompts with highly specific skills), and a few limited skills (I often modify and make a new skill per major repo I manage). Outside my environment I'm unaware of the current state, but most of my gains over the past 3 months have all been due to model improvements and codex updates. _I'm currently exploring Pi, and might have a new setup within 2-3 weeks based on present tests as of writing this._
...
> The AI is an *assistant*, not a driver, at least not with 2025 models. [(Kim and Yegge 139)](https://www.goodreads.com/en/book/show/228438060-vibe-coding)

Still true, and maybe more so. As we all deal with the code hangover it becomes apparent whom among us use agent as a tool to supercharge our abilities, and whom have supercharged shoty thinking. When the building can move 10X faster, it's more important than ever to understand each logical assumption that's baked into the code. Technologies are easier than ever to use; but wisdom and sound thinking are arguably harder than ever with the [siren call](<https://en.wikipedia.org/wiki/Siren_(mythology)>) from agents.
